...
function validarForcaSenha($senha) {
    ...
    // Verificar senhas comuns (opcional - requer lista)
    $commonPasswords = ['123456', 'password', '123456789', '12345678', '12345'];
    if (in_array(strtolower($senha), $commonPasswords)) return false;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!verifyCSRFToken($_POST['csrf_token'] ?? '', 'cadastro')) {
        ...
        // Inicializar variáveis de sessão para controle de tentativas
        ...
        if ($_SESSION['cadastro_tentativas'] > 5) {
            ...
            if (!isset($_POST['aceitar_termos'])) {
                ...
                // Se não há erros, prosseguir com cadastro
                if (empty($errors)) {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Função para validar CPF/CNPJ no cliente
