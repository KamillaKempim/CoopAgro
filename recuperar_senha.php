            ...
            <div class="recovery-container">
                ...
                <div class="recovery-body">
                    ...
                    <div class="step-indicator">
                        <div class="step <?php echo in_array($step, ['email', 'confirm', 'show_link', 'reset', 'invalid']) ? 'completed' : ''; ?>">1</div>
                        <div class="step-line"></div>
                        <div class="step <?php echo in_array($step, ['reset', 'invalid']) ? 'active' : ''; ?> <?php echo $step === 'invalid' ? '' : ''; ?>">2</div>
                    </div>
                    ...
                    <?php if ($step === 'email'): ?>
                        ...
                        <div class="security-note">
                            ...
                            <strong>Segurança:</strong> Por medida de segurança, não revelaremos se o email existe ou não em nosso sistema.
                        </div>
                        ...
                        <form method="POST" action="" id="emailForm">
                            <div class="mb-4">
                                ...
                                <input type="email" class="form-control" id="email" name="email" 
                                       required autofocus value="<?php echo htmlspecialchars($_POST['email'] ?? ''); ?>"
                        ...
                        <div class="alert alert-success">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p>
                                        Se o email informado existir em nosso sistema, você receberá um link de recuperação em breve.
                                    </p>
                                    <p class="mb-0">
                        ...
                        <div class="alert alert-warning">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p>Não foi possível enviar o email para <strong><?php echo htmlspecialchars($_SESSION['recovery_data']['email']); ?></strong>.</p>
                        ...
                        <div class="copy-link-box">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="recoveryLink" 
                                       value="<?php echo htmlspecialchars($_SESSION['recovery_data']['link']); ?>" readonly>
                            ...
                            <p class="text-muted small mb-2">
                                ...
                                Expira em: <?php echo date('d/m/Y H:i:s', strtotime($_SESSION['recovery_data']['expires'])); ?>
                            </p>
                            <div class="text-center">
                    ...
                    <?php elseif ($step === 'reset'): ?>
                        ...
                        <div class="security-note">
                            ...
                            <strong>Requisitos da senha:</strong> Mínimo 8 caracteres, com letras maiúsculas, minúsculas e números.
                        </div>
                        
                        <form method="POST" action="?step=reset&token=<?php echo htmlspecialchars($_GET['token'] ?? ''); ?>" id="resetForm">
                            <div class="mb-4">
                        ...
                        <div class="alert alert-danger">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Este link de recuperação não é válido ou já expirou. Por favor, solicite um novo link.</p>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkPasswordStrength(password) {
        ...
        return strength >= 3; // Pelo menos "Razoável"
    }
    ...
    // ========== VALIDAÇÃO DE FORMULÁRIO DE RESET ==========
    ...
    // ========== FUNÇÃO AUXILIAR PARA VALIDAR EMAIL NO CLIENTE ==========
    function isValidEmail(email) {
        const re = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
