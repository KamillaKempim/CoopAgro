                                ...
                                <div class="card product-card mb-4">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            ...
                                            ?>
                                            <img src="<?php echo $imagemSrc; ?>" class="img-fluid product-image w-100"
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text"><?php echo htmlspecialchars($produto['descricao']); ?>
                                                </p>
                                                <p class="card-text">
                                                    <span
                                                        class="badge bg-secondary"><?php echo htmlspecialchars($produto['tipo']); ?></span>
                                                </p>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="quantidade" name="quantidade"
                                            value="1" min="1" max="<?php echo $produto['quantidade_estoque']; ?>" required>
                                        <div class="form-text">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-end">
                                                <p class="mb-1" id="subtotal">R$
                                                    <?php echo number_format($produto['preco'], 2, ',', '.'); ?></p>
                                                <p class="mb-1" id="quantidade-display">1 unidade</p>
                                                <p class="mb-0"><strong id="total">R$
                                                        <?php echo number_format($produto['preco'], 2, ',', '.'); ?></strong>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
